<x-app-layout>
    ...
    <div class="py-12">
        ...
        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInputEmail1"
                                    ...
                                    <small id="emailHelp" class="block mt-1 text-xs text-gray-600">We'll never share
                                ...
                                <div class="form-group form-check mb-6">
                                    <input type="checkbox"
                                           ...
                                           id="exampleCheck1">
                                    <label class="form-check-label inline-block text-gray-800" for="exampleCheck1">Check
                                        me out</label>
                                </div>
